...
void TelegramBot::auth(std::string id)
{
    ...
    this->api->sendMessage(id, "https://oauth.vk.com/authorize?client_id=7533881&display=page&redirect_uri="
                               "https://1f93e5507e31.ngrok.io&scope=friends%2Cwall%2Cgroups%2Coffline&response_type=code&v=5.52");
}
...
void TelegramBot::parseCode(QUrl url)
{
    ...
    this->request.setUrl("https://oauth.vk.com/access_token?client_id=7533881&client_secret=00YyZZO3rpJLkgzh0MpB&redirect_uri=https://1f93e5507e31.ngrok.io&code="+code);
    this->reply = this->manager->get(this->request);
}
